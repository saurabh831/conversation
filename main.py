                ...
                for tg in intent["tag"]:
                    ...
                    for tr in t:
                        if tr == tg:
                            ...
                            b = intent["link"]
                            c = intent["task"]
                            d = intent["store_to_db"]
                            if random.choice(d) == "yes":
                                insert_(we, random.choice(a))
                            perform_(random.choice(c), random.choice(b))
        ...
        if tr == tag[0]:
            for tg in data["intents"]:
                if tg['tag'] == tag:
                    ...
                    d = tg["store_to_db"]
                    if random.choice(d) == "yes":
                        insert_(inp, random.choice(responses))
                    perform_(random.choice(c), random.choice(b))
